...
config :rumbl, RumblWeb.Endpoint,
  ...
  secret_key_base: "cEsHewLFww75XJ4Rs6e0eZQhg3zom2Icz9qPj+cewi+82JvarlYOO5zBMPCA6y9+",
  server: false
...
# para bajar el timepo que se gasta hasehando passwords en el test de auth,,Es decir no nos interesa el tiempo
